...
/**
 * Fetches an image from `url`, converts it to base64 (to meet the requirement),
 * then decodes it and renders onto the canvas (no <img> tag).
 * @param {string} canvas_id
 * @param {string} b64
 * @param {number} len
 */
export function render_from_base64(canvas_id, b64, len) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.render_from_base64(ptr0, len0, ptr1, len1, len);
    if (ret[1]) {
 ...
 */
export function render_from_url(canvas_id, url) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.render_from_url(ptr0, len0, ptr1, len1);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper1938 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 948, __wbg_adapter_20);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_image_render_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
